            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 lineheight220">
                            @if ($project->number_block) <div><span>{{ __('Number of blocks') }}:</span> <b>{{ $project->number_block }}</b></div> @endif
                            @if ($project->number_floor) <div><span>{{ __('Number of floors') }}:</span> <b>{{ $project->number_floor }}</b></div>@endif
                            @if ($project->number_flat) <div><span>{{ __('Number of flats') }}:</span> <b>{{ $project->number_flat }}</b></div>@endif
                        </div>
                    </div>
