...
use Botble\Paymentmanagement\Models\Tag;
use Botble\Paymentmanagement\Repositories\Interfaces\PostInterface;
...
class PublicController extends Controller
{
    ...
    public function getTag($slug, Request $request)
    {
        ...
        if (function_exists('admin_bar')) {
            admin_bar()->registerLink(trans('plugins/Paymentmanagement::tags.edit_this_tag'), route('tags.edit', $tag->id));
        }
        ...
        return Theme::scope('tag', compact('tag', 'posts'), 'plugins/Paymentmanagement::themes.tag')->render();
    }
}
