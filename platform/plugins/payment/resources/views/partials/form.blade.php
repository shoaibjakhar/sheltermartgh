...
<div class="checkout-wrapper">
    <div class="payment-checkout-form">
        <form action="{{ route('payments.checkout') }}" method="post">
            ...
            @if (setting('payment_stripe_status') == 1 || setting('payment_paypal_status') == 1 || setting('payment_cod_status') == 1 || setting('payment_bank_transfer_status') == 1)
                <br>
...
<script>window.jQuery || document.write('<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/1.12.4/jquery.min.js"><\/script>')</script>
