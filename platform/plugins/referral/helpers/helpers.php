...
use Botble\Referral\Supports\PostFormat;
...
if (!function_exists('get_featured_posts')) {
    ...
    {
        return app(SettingInterface::class)->getFeatured($limit, $with);
    }
}
...
if (!function_exists('get_latest_posts')) {
    ...
    {
        return app(SettingInterface::class)->getListPostNonInList($excepts, $limit);
    }
}
...
if (!function_exists('get_related_posts')) {
    ...
    {
        return app(SettingInterface::class)->getRelated($currentSlug, $limit);
    }
}
...
if (!function_exists('get_posts_by_category')) {
    ...
    {
        return app(SettingInterface::class)->getByCategory($categoryId, $paginate, $limit);
    }
}
...
if (!function_exists('get_posts_by_tag')) {
    ...
    {
        return app(SettingInterface::class)->getByTag($slug, $paginate);
    }
}
...
if (!function_exists('get_posts_by_user')) {
    ...
    {
        return app(SettingInterface::class)->getByUserId($authorId, $paginate);
    }
}
...
if (!function_exists('get_all_posts')) {
    ...
    {
        return app(SettingInterface::class)->getAllPosts($perPage, $active);
    }
}
...
if (!function_exists('get_recent_posts')) {
    ...
    {
        return app(SettingInterface::class)->getRecentPosts($limit);
    }
}
...
if (!function_exists('get_popular_posts')) {
    ...
    {
        return app(SettingInterface::class)->getPopularPosts($limit, $args);
    }
}
...
if (!function_exists('get_commession')) {
    /**
     * @param array $args
     * @return array|mixed
     */
    function get_commession(array $args = [],$repo,$where)
    {
